...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    weekly_top_articles: Schema.Attribute.Relation<
      'oneToMany',
      'api::article.article'
    >;
    weekly_top_titles: Schema.Attribute.Relation<
      'oneToMany',
      'api::article.article'
    >;
  };
...
export interface ApiMenuItemMenuItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    location: Schema.Attribute.Enumeration<['header', 'footer', 'both']>;
...
export interface ApiPipelineConfigPipelineConfig
  ...
  attributes: {
    ...
    geminiMockMode: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
